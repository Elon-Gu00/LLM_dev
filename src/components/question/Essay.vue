    ...
    <el-container>
        <el-aside class="edit-fill-blank border-right">
            <el-form :model="questionData" label-position="top" ref="fromRef" :rules="rules" hide-required-asterisk>
                ...
                <el-form-item prop="title">
                    ...
                    <el-input v-model="questionData.title" placeholder="题目名称" maxlength="30" show-word-limit
                              clearable/>
                </el-form-item>
                <el-form-item prop="description">
                    ...
                    <el-input v-model="questionData.description" type="textarea"
                              :rows="questionData.description.split('\n').length + 1" placeholder="题目描述"
                ...
                <el-form-item prop="answer">
                    ...
                    <el-input v-model="questionData.answer" type="textarea"
                              :rows="questionData.answer.split('\n').length + 1" placeholder="题目描述"
                              maxlength="300" show-word-limit resize="none"/>
                </el-form-item>
            </el-form>
        </el-aside>
        <el-aside class="preview-choice">
            ...
            <div class="preview-item" v-if="questionData.answer !== ''">
                ...
                <div>
                    <div v-for="(p) in questionData.answer.split('\n')">
                        {{ p }}
                    </div>
                </div>
            </div>
